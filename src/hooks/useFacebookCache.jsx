...
export const useFacebookInsights = (pageId, period, customDates, token) => {
  const apiFn = useCallback(async () => {
    ...
    let url = `https://3ixmj4hf2a.us-east-2.awsapprunner.com/api/meta/pages/${pageId}/insights`;
...
export const useFacebookPosts = (pageId, period, customDates, token, limit = 20) => {
  const apiFn = useCallback(async () => {
    ...
    let url = `https://3ixmj4hf2a.us-east-2.awsapprunner.com/api/meta/pages/${pageId}/posts?limit=${limit}`;
