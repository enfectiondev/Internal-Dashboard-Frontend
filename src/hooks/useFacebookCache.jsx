...
export const useFacebookInsights = (pageId, period, customDates, token) => {
  const apiFn = useCallback(async () => {
    ...
    let url = `https://eyqi6vd53z.us-east-2.awsapprunner.com/api/meta/pages/${pageId}/insights`;
...
export const useFacebookPosts = (pageId, period, customDates, token, limit = 20) => {
  const apiFn = useCallback(async () => {
    ...
    let url = `https://eyqi6vd53z.us-east-2.awsapprunner.com/api/meta/pages/${pageId}/posts?limit=${limit}`;
